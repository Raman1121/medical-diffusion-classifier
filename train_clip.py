# Source: https://github.com/huggingface/transformers/blob/main/examples/pytorch/contrastive-image-text/run_clip.py#L227
...
from parse_args_clip import ModelArguments, DataTrainingArguments
from clip_data import RetinalFundusDatasetCLIP
...
def main():
    ...
    if training_args.do_train:
        ...
        train_csv = pd.read_csv(data_args.train_csv)
    ...
    if training_args.do_eval:
        ...
        test_csv = pd.read_csv(data_args.test_csv)
